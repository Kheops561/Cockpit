...
const PAROLES = {
  ...
  vi: {
    methode: 'Phương thức không được phép.',
    recu: 'Đã nhận được tin nhắn.',
    manque: (liste) => `Còn thiếu: ${liste.join(', ')}.`,
    champs: {
      prenom: 'tên của bạn',
      nom: 'họ của bạn',
      courriel: 'một địa chỉ e-mail hợp lệ',
      qualite: 'bạn viết với tư cách nào',
      profil: 'hồ sơ gần với bạn nhất',
      echeance: 'thời hạn của bạn',
      message: 'vài dòng về tình hình của bạn',
      consent: 'sự đồng ý của bạn cho việc xử lý thông tin',
    },
    pasConfigure: (a) => `Biểu mẫu chưa được thiết lập. Xin viết thẳng tới ${a}.`,
    echec: (a) => `Gửi không thành công. Xin thử lại sau ít phút, hoặc viết thẳng tới ${a}.`,
    envoye: 'Đã gửi tin nhắn. Chúng tôi trả lời trong vòng một ngày làm việc.',
  },
  en: {
